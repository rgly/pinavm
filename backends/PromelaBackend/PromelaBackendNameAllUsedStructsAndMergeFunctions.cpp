...
/// program.
///
bool PromelaBackendNameAllUsedStructsAndMergeFunctions::
...
const char *PromelaBackendNameAllUsedStructsAndMergeFunctions::getPassName() const
{
	return "Promela backend type canonicalizer";
}

char PromelaBackendNameAllUsedStructsAndMergeFunctions::ID = 0;
