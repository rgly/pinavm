...
void
SCJit::setCurrentProcess(Process* process)
{
  this->currentProcess = process;
}

Process*
SCJit::getCurrentProcess()
{
...
Function*
SCJit::buildFct(Function* f, FunctionType* FT, Value* arg)
{
  Function* fctToJit;
...
void
fillArgsType(Function* f, std::vector<const Type*>* argsType)
{
...
void*
SCJit::jitAddr(Function* f, Value* arg)
{
  ...
  FunctionType* FT = FunctionType::get(arg->getType(), argsType, false);
...
SCJit::jitInt(Function* f, Value* arg)
{
  ...
  int (*fct)(sc_core::sc_module*) = (int (*)(sc_core::sc_module*)) ee->getPointerToFunction(fctToJit);
...
double
SCJit::jitDouble(Function* f, Value* arg)
{
  Function* fctToJit;
  const std::vector<const Type*> argsType;
  ...
  double (*fct)(sc_core::sc_module*) = (double (*)(sc_core::sc_module*)) ee->getPointerToFunction(fctToJit);
  double res = fct(this->elab->getSCModule(this->currentProcess->getModule()));
