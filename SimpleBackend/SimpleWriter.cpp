...
void SimpleWriter::printConstantVector(ConstantVector * CP, bool Static)
{
	Out << '{';
...
bool SimpleWriter::printConstExprCast(const ConstantExpr * CE, bool Static)
{
...
void SimpleWriter::printConstantWithCast(Constant * CPV, unsigned Opcode)
{
...
void SimpleWriter::writeInstComputationInline(Instruction & I)
{
...
void SimpleWriter::writeOperandDeref(Value * Operand)
{
...
void SimpleWriter::writeOperandInternal(Value * Operand, bool Static)
{
...
// for the Instruction.
bool SimpleWriter::writeInstructionCast(const Instruction & I)
{
...
void SimpleWriter::writeOperandWithCast(Value * Operand, unsigned Opcode)
{
...
// being used. 
void SimpleWriter::writeOperandWithCast(Value * Operand,
					const ICmpInst & Cmp)
{
...
void SimpleWriter::printFloatingPointConstants(Function & F)
{
...
void SimpleWriter::printFloatingPointConstants(const Constant * C)
{
...
void SimpleWriter::printLoop(Loop * L)
{
...
void SimpleWriter::visitSwitchInst(SwitchInst & SI)
{
	Out << "  switch (";
...
void SimpleWriter::visitInvokeInst(InvokeInst & I)
{
	llvm_unreachable("Lowerinvoke pass didn't work!");
}

void SimpleWriter::visitUnwindInst(UnwindInst & I)
{
	llvm_unreachable("Lowerinvoke pass didn't work!");
}

void SimpleWriter::visitUnreachableInst(UnreachableInst & I)
{
	Out << "  /*UNREACHABLE*/;\n";
}

void SimpleWriter::visitInstruction(Instruction & I)
{
#ifndef NDEBUG
...
void SimpleWriter::outputLValue(Instruction * I)
{
	Out << "  " << GetValueName(I) << " = ";
}
...
//
void SimpleWriter::visitBranchInst(BranchInst & I)
{
	if (I.isConditional()) {
...
// the PHI.
void SimpleWriter::visitPHINode(PHINode & I)
{
	writeOperand(&I);
	Out << "__PHI_TEMPORARY";
}
...
void SimpleWriter::visitBinaryOperator(Instruction & I)
{
...
void SimpleWriter::visitICmpInst(ICmpInst & I)
{
...
void SimpleWriter::visitFCmpInst(FCmpInst & I)
{
...
void SimpleWriter::visitCastInst(CastInst & I)
{
	const Type *DstTy = I.getType();
	const Type *SrcTy = I.getOperand(0)->getType();
...
void SimpleWriter::lowerIntrinsics(Function & F)
{
...
void SimpleWriter::visitInsertElementInst(InsertElementInst & I)
{
...
void SimpleWriter::visitExtractElementInst(ExtractElementInst & I)
{
...
void SimpleWriter::visitShuffleVectorInst(ShuffleVectorInst & SVI)
{
	Out << "(";
...
void SimpleWriter::visitInsertValueInst(InsertValueInst & IVI)
{
...
void SimpleWriter::visitExtractValueInst(ExtractValueInst & EVI)
{
	Out << "(";
