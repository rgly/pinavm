...
void
SimpleBackendNameAllUsedStructsAndMergeFunctions::getAnalysisUsage(AnalysisUsage &AU) const
{
...
///
bool
SimpleBackendNameAllUsedStructsAndMergeFunctions::runOnModule(Module &M)
{
